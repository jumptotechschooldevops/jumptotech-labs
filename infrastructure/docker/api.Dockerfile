...
RUN set -eux; \
    ...
    case "$arch" in \
      amd64) karch=amd64; darch=x86_64; ksum="$KUBECTL_SHA256_AMD64"; dsum="$DOCKER_CLI_SHA256_AMD64" ;; \
      arm64) karch=arm64; darch=aarch64; ksum="$KUBECTL_SHA256_ARM64"; dsum="$DOCKER_CLI_SHA256_ARM64" ;; \
