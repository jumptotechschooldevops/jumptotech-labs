...
export const githubWorkflowExists: CicdVerifierHandler<'github_workflow_exists'> = {
...
export const githubWorkflowTrigger: CicdVerifierHandler<'github_workflow_trigger'> = {
...
export const githubWorkflowJobExists: CicdVerifierHandler<'github_workflow_job_exists'> = {
...
export const githubWorkflowStepExists: CicdVerifierHandler<'github_workflow_step_exists'> = {
