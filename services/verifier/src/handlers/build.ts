...
export const commandExitCode: CicdVerifierHandler<'workspace_task_exit_code'> = {
  type: 'workspace_task_exit_code',
...
export const projectBuilds: CicdVerifierHandler<'project_builds'> = {
  type: 'project_builds',
...
export const testsPass: CicdVerifierHandler<'tests_pass'> = {
  type: 'tests_pass',
