...
import {
  ...
  terraformMovedDeclared,
  terraformOutputEquals,
  terraformOutputExists,
  terraformOutputSensitive,
  terraformProviderConfigured,
...
const SANDBOX_HANDLERS: { [K in SandboxRequirementType]: SandboxVerifierHandler<K> } = {
  ...
  terraform_variable_sensitive: terraformVariableSensitive,
  terraform_variable_validation: terraformVariableValidation,
  terraform_output_sensitive: terraformOutputSensitive,
  ...
  terraform_required_provider: terraformRequiredProvider,
  terraform_provider_configured: terraformProviderConfigured,
  terraform_resource_provider: terraformResourceProvider,
  ...
  terraform_backend_configured: terraformBackendConfigured,
  terraform_moved_declared: terraformMovedDeclared,
};
