...
export function sessionRecovery(
  ...
  describe(`${name} — lifecycle recovery (BETA-P0-007)`, () => {
    ...
    it('a start that finishes while the sweep is busy elsewhere is not torn down as abandoned', async () => {
      ...
      const older = await w.a.manager.start('LINUX-001', '00000000-0000-4000-8000-00000000a11c');
      ...
      const building = w.provider.holdNextCreate();
      const slow = w.b.manager.start('LINUX-001', '00000000-0000-4000-8000-000000000b0b');
      await building.entered;
